...
export const facilityChapters: readonly FacilityChapterDefinition[] = deepFreeze([
  {
    ...
    journeyProgress: 0,
    routeProgress: 0,
    atmosphere: { fogColor: "#10191b", fogDensity: 0.011, exposure: 0.92 },
    camera: { fov: 54, lookAhead: 0.035, roll: 0 },
  },
  {
    stageId: "proof",
    ...
    journeyProgress: 1 / 7,
    routeProgress: 0.12,
    atmosphere: { fogColor: "#111c1c", fogDensity: 0.016, exposure: 0.88 },
    camera: { fov: 49, lookAhead: 0.032, roll: -0.008 },
  },
  {
    stageId: "kota",
    zone: "voice-chamber",
    journeyProgress: 2 / 7,
    routeProgress: 0.29,
    atmosphere: { fogColor: "#0b1716", fogDensity: 0.025, exposure: 0.78 },
    camera: { fov: 45, lookAhead: 0.026, roll: 0.01 },
  },
  {
    stageId: "audiobook",
    ...
    journeyProgress: 3 / 7,
    routeProgress: 0.43,
    atmosphere: { fogColor: "#1a1b17", fogDensity: 0.021, exposure: 0.84 },
  ...
  },
  {
    ...
    journeyProgress: 4 / 7,
    routeProgress: 0.59,
    atmosphere: { fogColor: "#10191b", fogDensity: 0.014, exposure: 0.96 },
  ...
  },
  {
    ...
    journeyProgress: 5 / 7,
    routeProgress: 0.74,
    atmosphere: { fogColor: "#211a20", fogDensity: 0.018, exposure: 0.9 },
  ...
  },
  {
    ...
    journeyProgress: 6 / 7,
    routeProgress: 0.87,
    atmosphere: { fogColor: "#172020", fogDensity: 0.01, exposure: 0.98 },
  ...
  },
  {
    ...
    journeyProgress: 1,
    routeProgress: 1,
    atmosphere: { fogColor: "#1c2422", fogDensity: 0.007, exposure: 1 },
